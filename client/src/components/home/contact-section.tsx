        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            <form onSubmit={form.handleSubmit(onSubmit)} id="contact-form">
              ...
              <button 
                type="submit" 
                className="group relative w-full bg-gradient-to-r from-accent to-highlight hover:from-highlight hover:to-accent text-primary font-inter font-semibold px-8 py-4 rounded-xl transition-all duration-300 flex justify-center items-center shadow-xl shadow-accent/30 hover:shadow-2xl hover:shadow-accent/40 transform hover:scale-[1.02] hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-lg overflow-hidden"
