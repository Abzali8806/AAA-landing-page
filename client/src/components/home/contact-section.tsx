        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            <form onSubmit={form.handleSubmit(onSubmit)} id="contact-form">
              ...
              <button 
                type="submit" 
                className="w-full bg-accent hover:bg-accent/90 text-primary font-inter font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex justify-center items-center shadow-lg shadow-accent/20 hover:shadow-xl hover:shadow-accent/30 disabled:opacity-50 disabled:cursor-not-allowed"
