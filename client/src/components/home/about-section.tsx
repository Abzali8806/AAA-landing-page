        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <a 
                href="#contact" 
                className="bg-accent hover:bg-accent/80 text-white font-inter font-medium px-6 sm:px-8 py-3 rounded-md transition-colors duration-300 inline-block shadow-lg shadow-accent/20 text-center w-full sm:w-auto"
              >
                Work With Us
              </a>
            </motion.div>
