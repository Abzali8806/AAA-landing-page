      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10 flex items-center justify-center min-h-screen">
        <div className="hero-grid-930 gap-8 items-center justify-center w-full">
          ...
          >
            ...
            <img 
              src="https://images.unsplash.com/photo-1562813733-b31f71025d54?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600" 
              alt="Humanoid AI robot showcasing advanced automation capabilities and intelligent workflow processing" 
