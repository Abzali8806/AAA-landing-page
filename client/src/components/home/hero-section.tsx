        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center min-h-[80vh] lg:min-h-[85vh]">
          ...
          >
            ...
            >
              <a 
                href="#contact" 
                className="bg-accent hover:bg-accent/90 text-primary font-inter font-semibold px-8 py-4 rounded-lg transition-all duration-300 text-base sm:text-lg shadow-lg shadow-accent/20 hover:shadow-xl hover:shadow-accent/30 text-center"
              >
                Start Your Transformation
              </a>
              <a 
                href="#services" 
                className="border-2 border-accent text-white hover:bg-accent hover:text-primary font-inter font-semibold px-8 py-4 rounded-lg transition-all duration-300 text-base sm:text-lg text-center"
              >
                Explore Services
              </a>
            </motion.div>
